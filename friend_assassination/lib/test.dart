...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Friend Assassination',
      // Theme data for the application
      theme: ThemeData(
        // Setting brightness to dark for a dark theme
        brightness: Brightness.dark,
        // Primary color (used for app bars, buttons, etc.)
        primarySwatch: Colors.deepPurple,
        // Font family for the app
        fontFamily: 'Inter', // Assuming Inter font is available or use a default
      ),
      // Disabling the debug banner
      debugShowCheckedModeBanner: false,
      // Home screen of the app
      home: const FriendAssassinationMainPage(),
    );
  }
}

// FriendAssassinationMainPage widget: Represents the screen from the Figma design
class FriendAssassinationMainPage extends StatelessWidget {
  const FriendAssassinationMainPage({super.key});

  // Define colors based on the Figma design
