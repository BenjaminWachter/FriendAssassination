...
class _HomeWebPageContentState extends State<HomeWebPageContent> {
  ...
  static const Color mainPanelBackground = Color(
    0xFF25252B,
  ); // Background for the main content panel
  static const Color sidebarBackground = Color(
    0xFF1E1E24,
  ); // Slightly different if needed, or same as scaffold
  ...
  static const Color contentCardBackground = Color(
    0xFFFFFFFF,
  ); // Lighter card for content
  static const Color imagePlaceholderBg = Color(
    0xFFE0E0E5,
  ); // Background for the placeholder image area
  static const Color shapePlaceholderColor = Color(
    0xFFB0B0B5,
  ); // Color for geometric shapes
  ...
  static const Color paragraphOnDarkBg = Color(
    0xB3FFFFFF,
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(
              icon,
              color: isSelected ? navItemSelectedIconColor : navItemIconColor,
              size: 24,
            ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      color:
          mainPanelBackground, // Background of the entire area holding sidebar + content
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width:
                          double
                              .infinity, // Make button full width of its parent column
